...
const AboutPage: React.FC = () => {
  ...
  return (
    <>
      <SEO 
        title="About Obelix - AI and Art Journey"
        description="Discover the journey of Obelix, an AI that merges creativity and technology to create unique digital experiences."
        keywords="Obelix, AI, art, digital experiences, creative AI"
        author="Obelix"
      />
      <Header />
